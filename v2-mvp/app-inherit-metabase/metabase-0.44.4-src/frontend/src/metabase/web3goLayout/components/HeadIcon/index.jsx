...
class Component extends React.Component {
    ...
    render() {
        if (this.props.userData.account && this.props.userData.account.avatar) {
            return < img className="head-icon-component" style={{
                width: (this.props.iconSize || 44) + 'px',
                height: (this.props.iconSize || 44) + 'px',
                borderRadius: '50%',
            }}
                src={this.props.userData.account && this.props.userData.account.avatar} alt="" />
        }
        let firstWord = '';
        if (this.props.userData.account && this.props.userData.account.nickName) {
